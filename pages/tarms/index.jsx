...
const terms = () => {
  return (
    <div>
      <Meta title="terms UnchainPet: Decentralized Pet Adoption Network" />
        ...
        <section className="dark:bg-jacarta-800 relative py-16 md:py-24">
          ...
          <div className="container">
            ...
            <div className="article-content mx-auto max-w-[48.125rem]">
              ...
              <p>
                UnchainedPet is not a wallet provider, exchange, broker,
                financial institution, or creditor. UnchainedPet provides a
              ...
              <p>
                ...
                UnchainedPet relating to your access to and use of the Service.
                ...
                consent of UnchainedPet, and UnchainedPet’s failure to assert
              ...
              <p>
                ...
                compliance with applicable local laws. You and UnchainedPet
